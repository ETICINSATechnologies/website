...
WP LinkedIn Auto Publish has now been put into maintenance mode which means we are only going to maintain the functionality and provide limited support. However we are now focusing our efforts on our new plugin AutoSocial which provides the same functionality as WP LinkedIn Auto Publish but adds Facebook, Google My Business and Twitter and many more cool features! [Learn more](https://northernbeacheswebsites.com.au/autosocial/)
